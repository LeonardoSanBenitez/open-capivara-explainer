...
def get_logger(name: str, level=logging.INFO) -> logging.Logger:
    logger = logging.Logger('libs.' + name)
...
def setup_loggers(root_level = logging.WARNING, modules_debug: List[str] = [], modules_info: List[str] = [], modules_error: List[str] = []) -> None:
    '''
    ...
    Loggers instantiated with `logging.getLogger` will not be affected by this call...?
    '''
