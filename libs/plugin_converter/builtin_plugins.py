...
answer_definition_text_and_code = {
    "name": "answer",
    "description": "Send response back to the user. Show all your results here, this is the only thing that the user will see."
                   " You won't be able to call any other function after this one."
                   " Be sure to return a complete and clear answer, the user will not be able to see any other intermediate messages nor ask for more information."
    ...
    "parameters": {
        ...
        "properties": {
            "text": {
                "type": "string",
                "description": "textual response to be send to the user. Should use HTML syntax for formatting.",
            },
            "code": {
                "type": "string",
                "description": "python code to generate visualization. Should always be valid code, than can be run as it is."
...
answer_definition_text_and_echart = {
    "name": "answer",
    "description": "Send response back to the user. Show all your results here, this is the only thing that the user will see."
                   " You won't be able to call any other function after this one."
                   " Be sure to return a complete and clear answer, the user will not be able to see any other intermediate messages nor ask for more information."
